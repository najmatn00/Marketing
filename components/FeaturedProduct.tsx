    ...
    <section className="bg-white py-12 md:py-16 lg:py-20">
      <div className="container mx-auto px-4 md:px-6" dir="rtl">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center gap-4 md:gap-0">
          ...
          hover:text-text-color transition-all shadow-md hover:shadow-lg group"
            >
              <svg
                className="w-5 h-5 md:w-6 md:h-6 text-dark-blue group-hover:text-text-color transition-colors rotate-90 md:rotate-0"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div className="w-full md:w-auto flex flex-col md:flex-row items-center justify-center order-1 md:order-2">
            ...
            <div className="hidden md:block md:w-[300px] lg:w-[451px] md:h-[400px] lg:h-[607px] bg-primary rounded-2xl overflow-hidden shadow-md"></div>
