...
type ResponsiveModalTriggerProps = React.ComponentPropsWithoutRef<
...
type ResponsiveModalTitleProps = React.ComponentPropsWithoutRef<
  typeof DialogTitle
>;
...
export function ResponsiveModalTitle({ ...props }: ResponsiveModalTitleProps) {
  ...
  if (isDesktop) {
    return (
      <DialogTitle
        {...props}
        className="text-right text-base font-bold lg:text-lg"
      />
    );
  }
...
type ResponsiveModalDescriptionProps = React.ComponentPropsWithoutRef<
...
export function ResponsiveModalDescription({
  ...
  if (isDesktop) {
    return (
      <DialogDescription {...props} className="text-right text-xs lg:text-sm" />
    );
  }
