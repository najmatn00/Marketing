...
export default function SpecialOffers() {
  ...
  const offers = [
    ...
    },
    {
      ...
      discountPrice: "623,000",
      discount: 30,
      image: "/images/B2B.webp",
    },
    {
      id: 5,
      name: "توپ فوتبال آدیداس",
      originalPrice: "650,000",
      discountPrice: "455,000",
      discount: 30,
      image: "/images/B2B.webp",
    },
    {
      id: 6,
      name: "لوازم آرایشی مک",
      originalPrice: "3,200,000",
      discountPrice: "2,400,000",
      discount: 25,
      image: "/images/B2B.webp",
    },
    {
      id: 7,
      name: "ماشین کنترلی بزرگ",
    ...
    {
      id: 9,
      name: "پودر پروتئین ایزوپیور",
      originalPrice: "2,800,000",
      discountPrice: "2,240,000",
      discount: 20,
      image: "/images/B2B.webp",
    },
    {
        ...
        <div className="flex items-center justify-between mb-8 md:mb-12 gap-4">
          ...
          <div className="flex flex-row-reverse gap-2 md:gap-3">
            <button
              ...
              className="w-10 h-10 md:w-12 md:h-12 bg-white border-2 border-light-grey rounded-xl flex items-center justify-center hover:border-primary hover:bg-primary hover:text-text-color transition-all shadow-md hover:shadow-lg group"
            >
              <svg
          ...
          {offers.map((offer) => (
            ...
            >
              ...
              <div className="p-4 md:p-5 text-right">
                <h3 className="text-dark-blue font-semibold mb-2 md:mb-3 text-base md:text-lg line-clamp-2">
                  {offer.name}
                </h3>
