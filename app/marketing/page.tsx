...
export default function MarketingPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-primary to-dark-blue py-24">
        ...
        <section className="bg-white py-20">
          <div className="container mx-auto px-6" dir="rtl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {/* Benefit 1 */}
              <div className="bg-light-mint rounded-3xl p-8 text-center hover:shadow-xl transition-shadow">
          ...
          <div className="container mx-auto px-6" dir="rtl">
            <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-2xl p-12">
              ...
              <form className="space-y-6">
                <div>
                  <label className="block text-dark-blue font-semibold mb-2 text-right">
                    نام و نام خانوادگی
                  </label>
                  <input
                    type="text"
                    className="w-full px-4 py-3 border-2 border-light-grey rounded-xl focus:border-primary focus:outline-none text-right"
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-primary text-white text-xl font-bold rounded-xl hover:bg-opacity-90 hover:scale-105 transition-all shadow-lg hover:shadow-xl"
                >
                  ثبت نام
                </button>
              </form>
