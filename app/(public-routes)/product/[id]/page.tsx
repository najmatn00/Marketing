      ...
      <main className="container mx-auto px-4 py-4 md:py-8" dir="rtl">
        ...
        <div className="flex flex-col md:flex-row mb-8 md:mb-12 gap-4 md:gap-6">
            ...
            <div className="flex gap-2 md:gap-4  md:flex-row-reverse flex-col ">
              ...
              <div className="flex-1 relative order-1">
                <div className="w-full max-w-[530px] h-auto aspect-square bg-light-grey rounded-xl md:rounded-2xl overflow-hidden relative">
                  ...
                  {/* Discount Badge */}
                  {product.discount > 0 && (
                    <div className="absolute top-2 right-2 md:top-4 md:right-4 bg-primary text-text-color px-3 py-1.5 md:px-4 md:py-2 rounded-lg text-xs md:text-sm font-bold">
          ...
          <div className="w-full md:w-2/4">
            ...
            <p className="text-primary hover:underline text-base md:text-lg lg:text-[20px] font-semibold mb-4 md:mb-6 inline-block">
              {" "}
              ویژگی های محصول
            </p>
            {/* Variants */}
              ...
              {product.variants.map((variant, index) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-dark-blue font-bold text-sm md:text-base">
                      تومان {variant.price}
                    </span>
                  </div>
                </button>
            ...
            <a
              href="#specifications"
              className="text-primary hover:underline text-sm md:text-base lg:text-[18px] mb-4 md:mb-6 inline-block"
            >
              مشاهده همه ویژگی‌ها
            </a>
            ...
            <div className="bg-light-grey rounded-lg p-3 md:p-4 mb-4 md:mb-6">
              ...
              <div className="flex items-center justify-between">
                <span className="text-dark-blue text-xs md:text-sm">
                  قیمت نهایی:
                </span>
            ...
            {/* Add to Cart Button */}
            <button className="w-full py-3 md:py-4 bg-primary text-text-color text-base md:text-lg font-bold rounded-lg hover:bg-opacity-90 transition-all shadow-md hover:shadow-lg">
              افزودن به محصول
            </button>
          </div>
        </div>
        ...
        <div className="rounded-xl md:rounded-2xl p-4 md:p-8 mb-8 md:mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-text-color mb-3 md:mb-4 text-center bg-primary p-2 rounded-t-xl md:rounded-t-2xl">
            درباره محصول
          </h2>
