      ...
      <main>
        ...
        <section className="bg-gradient-to-br from-primary to-dark-blue py-12 md:py-16 lg:py-24">
          <div className="container mx-auto px-4 md:px-6" dir="rtl">
            <div className="text-center text-text-color max-w-4xl mx-auto">
          ...
          <div className="container mx-auto px-4 md:px-6" dir="rtl">
            <div className="max-w-2xl mx-auto bg-white rounded-2xl md:rounded-3xl shadow-2xl p-6 md:p-10 lg:p-12">
              ...
              <form className="space-y-4 md:space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-3 md:py-4 bg-primary text-text-color text-base md:text-lg lg:text-xl font-bold rounded-xl hover:bg-opacity-90 hover:scale-105 transition-all shadow-lg hover:shadow-xl"
                >
                  ثبت نام
                </button>
              </form>
