...
export default function SpecialOfferPage() {
  ...
  > = {
    ...
    "2": {
      ...
      description:
        "کلکسیون بهاره با تخفیف های باورنکردنی. همین حالا خرید کنید!",
      mainImage: "/images/B2B.webp",
      discount: 40,
  ...
  const featuredProducts = Array(8)
    .fill(null)
    .map((_, i) => ({
      id: i + 1,
      name: `محصول ویژه ${i + 1}`,
          ...
          <div className="container mx-auto px-6" dir="rtl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-right space-y-6">
                <div className="inline-block bg-primary text-text-color px-6 py-2 rounded-full text-2xl font-bold shadow-lg">
